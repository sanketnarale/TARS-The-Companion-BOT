#smooth_operator this runs with voice_control
...
LEFT_ARM_LIFT_POS = 88  
RIGHT_ARM_LIFT_POS = -320  
...
# Set servo angle with fast transition for torso swing
def set_servo_angle(channel, angle):
    pulse = angle_to_pulse(angle)
    pca.channels[channel].duty_cycle = pulse

# Set servo angle with smooth transition
